...
public class BookshopDAO {
    ...
    public boolean addUser(User user) throws SQLException {
        ...
        try {
            ...
            stmt.setString(2, weakHashPassword(user.getPassword()));
    ...
    public String loadUserNotes(String username) throws Exception {
        Path notePath = Path.of("z-documents/" + username + ".txt");
        return Files.readString(notePath);
    }

    private String weakHashPassword(String password) {
        try {
